...
- 🤖 **AI智能建议** - 基于Chrome内置AI的内容优化建议
- 📊 **详细报告** - 全面的SEO检查报告，包含技术SEO、内容质量、性能指标
- 🚀 **批量检查** - 支持多个URL的批量SEO分析
...
- Chrome 88+ 版本
- 支持Chrome内置AI功能（需要在chrome://flags中启用相关实验性功能）
...
- **Prompt API**：生成内容优化建议
- **Summarization API**：内容摘要和分析
- **Language Detection API**：自动检测页面语言

> **注意**：AI功能需要Chrome 88+版本，并在chrome://flags中启用相关实验性功能。
